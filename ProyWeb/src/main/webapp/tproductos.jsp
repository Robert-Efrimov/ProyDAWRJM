...
<html lang="es">
<head>
  <title>Tablas de productos</title>
  <meta charset="utf-8">
  ...
  <div class="container-fluid">
	...
	<div class="container mt-3" style="margin-top: 120px !important;">
		<div class="row">
			...
			<h1 class="text-center mb-3">Tablas de productos</h1>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								for (int i = 0; i < listaProductos.size(); i++) {
									...
									out.println("<td>" + listaProductos.get(i).getCod_prod() + "</td>");
									out.println("<td>" + listaProductos.get(i).getNom_prod() + "</td>");
									out.println("<td>" + listaProductos.get(i).getNom_cons() + "</td>");
									out.println("<td>" + listaProductos.get(i).getGenero_prod() + "</td>");
									out.println("<td>" + listaProductos.get(i).getPrecio_prod() + "</td>");
									out.println("<td>" + listaProductos.get(i).getDescripcion() + "</td>");
									out.println("<td>" + listaProductos.get(i).getImagenes() + "</td>");
									out.println("</tr>");
								}
								%>
							</tbody>
