		...
		<div class="row">
			...
			<div class="container-fluid">
				...
				for (int i = 0; i < lista.size(); i++) {
					...
					out.print("<p class='text-center mt-3' style='font-size: 18px; font-weight: bold;'>"
							+ lista.get(i).getPrecio_prod() + "&euro;</p>");
					out.print("<button type = 'submit' name = 'botonDetalle' value='" + lista.get(i).getCod_prod()
							+ "'class='w-100 btn btn-danger' style='background-color: #d736ff; border: none; :hover{color: #d736ff; border: 1px solid #d736ff; background-color: black}'>DETALLES PRODUCTO</button>");
					out.print("</div>");
						}
			...
			<footer class="bg-dark text-white">
				<div class="container">
					<nav class="row">
						...
						<p>Redes Sociales:</p>
						<ul type="none">
							<li><a href="#"><img id="rs" src="images/lk.png"
									alt="linkedin"></a></li>
							<li><a href="#"><img id="rs" src="images/ig.png"
									alt="instagram"></a></li>
							<li><a href="#"><img id=rs src="images/fb.png"
									alt="facebook"></a></li>
						</ul>
					</nav>
				</div>
